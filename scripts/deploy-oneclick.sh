...
for env_name in \
  ...
  COMPOSE_PROJECT_NAME AGP_CONTAINER_PREFIX AGP_DATA_DIR AGP_LOG_DIR \
...
export COMPOSE_PROJECT_NAME AGP_CONTAINER_PREFIX AGP_DATA_DIR AGP_LOG_DIR MYSQL_DATABASE MYSQL_USER MYSQL_PASSWORD MYSQL_ROOT_PASSWORD
