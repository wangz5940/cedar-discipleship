...
type Repository interface {
	ValidateWeeklyTarget(ctx context.Context, groupID, taskID, weekID uint64, taskType, logicalDate string) error
	FindExistingDaily(ctx context.Context, groupID, userID uint64, taskType, logicalDate string) (uint64, error)
